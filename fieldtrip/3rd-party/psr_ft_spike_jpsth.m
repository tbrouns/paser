function [stat] = psr_ft_spike_jpsth(cfg, psth)
...
if        strcmp(cfg.trials,'all'); cfg.trials = 1:size(psth.trial,1);
...
cfg.channelcmb = ft_channelcombination(cfg.channelcmb, psth.label, 1);
...
% collect the results
if strcmp(cfg.method,'jpsth'); stat.jpsth          = out;
else,                          stat.shiftpredictor = out;
end
