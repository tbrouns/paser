function parameters = psr_sst_display_parameters(parameters)
...
% figure layout
parameters.display.default_figure_size         = [0.05 0.1 0.9 0.8]; % location of default figure
...
parameters.display.margin       = 140; % number of pixels between plots
parameters.display.outer_margin = 80;  % number of pixels around at figure margin
parameters.display.width        = 140; % number of pixels in plot width
parameters.display.aspect_ratio = 2/3; % aspect ratio of plots
