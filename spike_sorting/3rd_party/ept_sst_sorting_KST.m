function rez = ept_sst_sorting_KST(data,parameters,savePath)
...
ops = ept_kst_convert2binary(ops);
% NOTE: we do not use Kilosort's "convertOpenEphysToRawBInary" to load from
% CONTINUOUS files, because it is incompatible with our own load function
