function data = ept_preprocessing(data_input,parameters)
    ...
    step   = 0.5 * parameters.lfp.bp_low;
    F_low  = parameters.lfp.bp_low:step:parameters.lfp.freq_lower; % Try different frequencies (in Hz)
    ...
    for i = 1:length(orders);
        ...
        for j = 1:length(F_low)
            ...
            cfg.preproc.bpfreq     = [F_low(j), parameters.lfp.bp_high];
